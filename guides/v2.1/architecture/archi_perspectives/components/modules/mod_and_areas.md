...
* **Cron** (`crontab`): In `cron.php`, the [`\Magento\Framework\App\Cron`](https://github.com/magento/magento2/blob/2.2/lib/internal/Magento/Framework/App/Cron.php#L78-L80){:target="_blank"} class always loads the 'crontab' area.
